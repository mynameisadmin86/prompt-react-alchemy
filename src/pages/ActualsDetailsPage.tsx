...
import { X, Truck, Container as ContainerIcon, Package, Box, Calendar, Info } from 'lucide-react';
...
export default function ActualsDetailsPage() {
    ...
    <div className="fixed inset-0 z-50 bg-background">
      ...
      <div className="h-14 border-b flex items-center justify-between px-6">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-semibold">Actuals Details</h2>
        </div>
      </div>
      ...
      <div className="flex h-[calc(100vh-56px)]">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          <DynamicPanel
            ...
            panelIcon={<Truck className="h-5 w-5 text-blue-600" />}
            panelConfig={{
              wagonType: {
                id: 'wagonType',
                label: 'Wagon Type',
          ...
          <DynamicPanel
            ...
            panelIcon={<ContainerIcon className="h-5 w-5 text-purple-600" />}
            panelConfig={{
              containerType: {
                id: 'containerType',
          ...
          <DynamicPanel
            ...
            panelIcon={<Package className="h-5 w-5 text-pink-600" />}
            panelConfig={{
              hazardousGoods: {
                id: 'hazardousGoods',
          ...
          <DynamicPanel
            ...
            panelIcon={<Box className="h-5 w-5 text-cyan-600" />}
            panelConfig={{
              thuId: {
                id: 'thuId',
                label: 'THU ID',
              ...
              thuLengthUnit: {
                ...
                label: 'Unit',
                fieldType: 'select',
                value: actualsData.thuLengthUnit || '',
                mandatory: false,
                visible: true,
                editable: true,
                order: 11,
              ...
              thuWidthUnit: {
                ...
                label: 'Unit',
                fieldType: 'select',
                value: actualsData.thuWidthUnit || '',
                mandatory: false,
                visible: true,
                editable: true,
                order: 13,
              ...
              thuHeightUnit: {
                ...
                label: 'Unit',
                fieldType: 'select',
                value: actualsData.thuHeightUnit || '',
                mandatory: false,
                visible: true,
                editable: true,
                order: 15,
          ...
          <DynamicPanel
            ...
            panelTitle="Journey Details"
            panelIcon={<Calendar className="h-5 w-5 text-orange-600" />}
            panelConfig={{
              departure: {
                id: 'departure',
                label: 'Departure',
                ...
                width: 'third',
                options: [
                  { label: 'Station A', value: 'station-a' },
          ...
          <DynamicPanel
            ...
            panelIcon={<Info className="h-5 w-5 text-gray-600" />}
            panelConfig={{
              qcUserdefined1: {
                id: 'qcUserdefined1',
                label: 'QC User Defined 1',
                fieldType: 'text',
