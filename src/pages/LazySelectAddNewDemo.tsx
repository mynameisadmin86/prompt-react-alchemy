...
export default function LazySelectAddNewDemo() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-foreground">LazySelect - Add New Item Demo</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="md:col-span-2">
          <CardHeader>
            <CardTitle className="text-lg">Standard LazySelect (No Add New)</CardTitle>
            <CardDescription>
