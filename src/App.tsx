...
import SmartGridPlusWithNestedPanelDemo from "./pages/SmartGridPlusWithNestedPanelDemo";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Route path="/trip-execution" element={<TripExecution />} />
          ...
          <Route path="/smartgrid-plus-nested-panel-demo" element={<SmartGridPlusWithNestedPanelDemo />} />
