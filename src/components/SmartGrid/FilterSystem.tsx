...
export function FilterSystem({
  ...
  const filterableColumns = columns.filter(col => col.advancedFilterable !== false);
  const filterableSubRowColumns = subRowColumns.filter(col => col.advancedFilterable !== false);
