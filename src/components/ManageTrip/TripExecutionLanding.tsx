...
export const TripExecutionLanding = ({ isEditTrip, tripData }: NewCreateTripProps) => {
  ...
  // Removed messageTypes and related state/hooks as QC data fetching is now handled by TripForm.tsx
  // const messageTypes = [
  ...
  // Removed useEffect for fetchAll and related functions, as QC data fetching is now handled by TripForm.tsx
  // useEffect(() => {
  //   fetchAll();
  // }, []);
